public class RegistroAcademicoPosGraduacao {
    ...
    public RegistroAcademicoPosGraduacao(String nomeDoAluno, String matricula,
            String curso, String tituloTese, String orientador) {
    ...
    public String toString() {
        ...
        res += "Nome do orientador: " + orientador + "\n";
        return res;
    }
}